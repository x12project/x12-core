...
* Running x12 node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/x12examples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/x12/testnet_pvt```. 
